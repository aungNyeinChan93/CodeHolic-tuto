...
<head>
    ...
    <!-- bootstrap core css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('Finexo/css/bootstrap.css') }}" />
    ...
    <!-- font awesome style -->
    <link href="{{ asset('Finexo/css/font-awesome.min.css') }}" rel="stylesheet" />

    <!-- Custom styles for this template -->
    <link href="{{ asset('Finexo/css/style.css') }}" rel="stylesheet" />
    <!-- responsive style -->
    <link href="{{ asset('Finexo/css/responsive.css') }}" rel="stylesheet" />
...
<body>
    ...
    <div class="hero_area">
        ...
        <div class="hero_bg_box">
            <div class="bg_img_box">
                <img src="{{ asset('Finexo/images/hero-bg.png') }}" alt="">
            </div>
        </div>
                    ...
                    <div class="carousel-item active">
                        <div class="container ">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="img-box">
                                        <img src="{{ asset('Finexo/images/slider-img.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container ">
                ...
                <div class="row">
                    <div class="col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('Finexo/images/s1.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Currency Wallet
                    ...
                    <div class="col-md-4 ">
                        <div class="box ">
                            <div class="img-box">
                                <img src="{{ asset('Finexo/images/s3.png') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h5>
                                    Expert Support
    ...
    <!-- bootstrap js -->
    <script type="text/javascript" src="{{ asset('Finexo/js/bootstrap.js') }}"></script>
    <!-- owl slider -->
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js">
    </script>
    <!-- custom js -->
    <script type="text/javascript" src="{{ asset('Finexo/js/custom.js') }}"></script>
    <!-- Google Map -->
